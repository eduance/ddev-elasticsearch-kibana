...
# ddev-elasticsearch <!-- omit in toc -->

* [What is ddev-elasticsearch?](#what-is-ddev-elasticsearch)
* [Components of the repository](#components-of-the-repository)
* [Getting started](#getting-started)

## What is ddev-elasticsearch?

This repository is a template for providing [DDEV](https://ddev.readthedocs.io) add-ons and services.

In DDEV addons can be installed from the command line using the `ddev get` command, for example, `ddev get ddev/ddev-elasticsearch` or `ddev get ddev/ddev-drupal9-solr`.
...
* The fundamental contents of the add-on service or other component. For example, in this template there is a [docker-compose.elasticsearch.yaml](docker-compose.elasticsearch.yaml) file.
...
3. Globally replace "elasticsearch" with the name of your add-on.
4. Add the files that need to be added to a ddev project to the repository. For example, you might remove `docker-compose.elasticsearch.yaml` with the `docker-compose.*.yaml` for your recipe.
